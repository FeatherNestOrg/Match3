 ...
 */
namespace Match3::Easing
{
    template <typename T>
    constexpr T pow(T x, size_t y)
    {
    ...
    inline float InElastic(float t)
    {
        ...
        return t == 0.0f
                   ...
                   : t == 1.0f
                   ? 1.0f
                   : -pow(2.0f, 10.0f * t - 10.0f) * std::sin((t * 10.0f - 10.75f) * c4);
    }
    ...
    inline float OutElastic(float t)
    {
        ...
        return t == 0.0f
                   ...
                   : t == 1.0f
                   ? 1.0f
                   : pow(2.0f, -10.0f * t) * std::sin((t * 10.0f - 0.75f) * c4) + 1.0f;
    }
    ...
    inline float InOutElastic(float t)
    {
        ...
        return t == 0.0f
                   ...
                   ? 1.0f
                   : t < 0.5f
                   ? -(pow(2.0f, 20.0f * t - 10.0f) * std::sin((20.0f * t - 11.125f) * c5)) / 2.0f
                   : (pow(2.0f, -20.0f * t + 10.0f) * std::sin((20.0f * t - 11.125f) * c5)) / 2.0f + 1.0f;
    }
