...
- [x] 1.1 创建 Game 主类，负责游戏循环
- [x] 1.2 初始化 SDL3 窗口和渲染器
- [x] 1.3 实现基本的事件处理（退出、键盘输入）
- [x] 1.4 实现游戏主循环（固定时间步长）
- [x] 1.5 添加 FPS 显示和基本的性能监控
...
- [x] 2.1 创建 Texture 纹理管理类
- [x] 2.2 创建 Renderer 渲染封装类
- [x] 2.3 实现颜色宝石的简单图形绘制（圆形/方块）
- [x] 2.4 创建 ResourceManager 资源管理器
- [x] 2.5 添加精灵表（Sprite Sheet）支持（可选）
